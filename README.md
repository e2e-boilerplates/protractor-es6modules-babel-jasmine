...
Protractor end-to-end test automation boilerplate, Using [ES Modules](https://hacks.mozilla.org/2018/03/es-modules-a-cartoon-deep-dive/), [Babel](https://babeljs.io), [Jasmine](https://jasmine.github.io) and Expect.. Clone or fork this repository.
